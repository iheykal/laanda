...
New-NetFirewallRule -DisplayName "Node.js Server" -Direction Inbound -Protocol TCP -LocalPort 3000,8000 -Action Allow
```
...
Open phone browser: `http://192.168.100.32:8000`
...
📱 Access from phone: http://192.168.100.32:8000
MongoDB Connected…
```
...
|--------|-------------|-------------|
| PC     | http://localhost:3000 | http://localhost:8000 |
| Phone  | http://192.168.100.32:3000 | http://192.168.100.32:8000 |
| Any Device on Same WiFi | http://192.168.100.32:3000 | http://192.168.100.32:8000 |
